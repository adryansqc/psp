    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-6">
            ...
            <form method="POST" action="{{ route('auth.create-password.update') }}">
                ...
                <a href="{{ route('auth.create-password.skip') }}" class="mt-4 block text-center cursor-pointer w-full bg-slate-400 text-white py-2 rounded-lg hover:bg-slate-500 transition duration-200">Lewati</a>
            </form>
        </div>
    </div>
@endsection
