        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p>Connect with our dedicated professionals for personalized assistance, detailed information, and
                        seamless guidance tailored to your needs. Our experienced team is committed to delivering attentive
                        service, ensuring every inquiry is handled with precision, discretion, and a genuine commitment to
                        excellence.</p>
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="item email" style="display:flex; align-items:center; gap:15px;">
                                <h6 style="margin:0;">
                                    {{ $settingItems['email']->value ?? 'Email Perusahaan' }}<br><span>Business Email</span>
                                </h6>
                            </div>
                        </div>
                    </div>
