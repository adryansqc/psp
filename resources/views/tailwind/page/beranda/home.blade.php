...
@if ($sliders->isNotEmpty())
    ...
    <section
        class="relative h-[90vh] min-h-[560px] flex items-center overflow-hidden"
    ...
    <section class="py-0 bg-white mt-0">
        <div class="max-w-5xl mx-auto px-6 lg:px-10">
            <div class="mt-0 rounded-3xl aspect-video w-full overflow-hidden shadow-2xl" data-aos="fade-up" data-aos-delay="100">
                <iframe
                    class="w-full h-full"
                    src="https://www.youtube-nocookie.com/embed/3imCL4Bk83c"
                    title="Profil PT. Putra Sentosa Prakarsa"
                    frameborder="0"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            ...
            @if ($pinnedProjects->isNotEmpty())
                ...
                <div
                    ...
                    x-init="updateEdges(); startAutoplay()"
                >
                    <button
                        @click="scroll(-1)"
                        :disabled="atStart"
                    ...
                    <div
                        x-ref="track"
                        @scroll.debounce.100ms="updateEdges()"
                    ...
                    >
                        @foreach ($pinnedProjects as $i => $project)
                            <a href="#" class="group block shrink-0 w-[80%] sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.334rem)] snap-start"
                               data-aos="fade-up" data-aos-delay="{{ ($i % 3) * 100 }}">
                                ...
                                <h3 class="mt-1 font-display text-xl text-ink group-hover:text-forest-light transition-colors">
                                    {{ $project->nama_projek }}
                                </h3>
                            </a>
                        @endforeach
            ...
            @else
                <div class="mt-16 flex flex-col items-center justify-center py-16 border border-dashed border-ink/15 rounded-3xl">
                    <svg class="w-10 h-10 text-ink-soft/40 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                @foreach ($pinnedProjects as $i => $project)
                    ...
                    data-aos="fade-up" data-aos-delay="{{ ($i % 3) * 100 }}">
                        ...
                        <div class="pt-5">
                            ...
                            <h3 class="mt-2 font-display text-xl text-ink group-hover:text-forest-light transition-colors">
                                {{ $project->nama_projek }}
                            </h3>
                        </div>
                    </a>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            ...
            <div class="mt-14 rounded-3xl overflow-hidden shadow-lg"
